...
Dieser Style Guides hat sich zum Ziel gesetzt, eine Sammlung mit optimalen Vorgehensweisen und *Style Guidelines* einer AngularJS Applikation anzubieten.

Diese optimalen Vorgehensweisen kamen von folgenden Stellen zusammen:
0. AngularJS Quellcode
0. Quellcode oder Artikel, welche ich gelesen habe
0. Meine eigene Erfahrungen

**Notiz**: Das ist noch immer ein ein Entwurf des *Style Guides*, sein Hauptziel ist es, von der Gemeindschaft gesteuert zu sein.
